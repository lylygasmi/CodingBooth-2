 ...
 */
final class Version20220219130145 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id_commande INT AUTO_INCREMENT NOT NULL, id_produit INT DEFAULT NULL, id_client INT DEFAULT NULL, nom_client VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, numero_client INT NOT NULL, code_promo VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, date_commande DATE NOT NULL, etat_commande VARCHAR(255) NOT NULL, mode_paiment VARCHAR(255) NOT NULL, INDEX fk18 (id_client), INDEX fk19 (id_produit), PRIMARY KEY(id_commande)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE emploi (idemploi INT AUTO_INCREMENT NOT NULL, id_coach INT DEFAULT NULL, idcours INT DEFAULT NULL, idsalle INT DEFAULT NULL, date DATE NOT NULL, heure TIME NOT NULL, INDEX fk20 (idsalle), INDEX fk21 (idcours), INDEX fk22 (id_coach), PRIMARY KEY(idemploi)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lignecommande (id_lcommande INT AUTO_INCREMENT NOT NULL, id_commande INT DEFAULT NULL, id_produit INT DEFAULT NULL, quantite INT NOT NULL, INDEX fk24 (id_produit), INDEX fk25 (id_commande), PRIMARY KEY(id_lcommande)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE participation (idparticipation INT AUTO_INCREMENT NOT NULL, idevent INT DEFAULT NULL, iduser INT DEFAULT NULL, dateparticipation DATETIME NOT NULL, INDEX fk1 (iduser), INDEX fk2 (idevent), PRIMARY KEY(idparticipation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE produit (id_produit INT AUTO_INCREMENT NOT NULL, nonprod VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, type_produit VARCHAR(255) NOT NULL, PRIMARY KEY(id_produit)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse (id_rep INT AUTO_INCREMENT NOT NULL, idutilisateur INT DEFAULT NULL, id_rec INT DEFAULT NULL, INDEX fk16 (id_rec), INDEX fk17 (idutilisateur), PRIMARY KEY(id_rep)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reservationticket (idreservation INT AUTO_INCREMENT NOT NULL, iduser INT DEFAULT NULL, idticket INT DEFAULT NULL, quatite INT NOT NULL, montant DOUBLE PRECISION NOT NULL, INDEX fk11 (idticket), INDEX fk12 (iduser), PRIMARY KEY(idreservation)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE typeproduit (idtype INT AUTO_INCREMENT NOT NULL, id_produit INT DEFAULT NULL, nomtype INT NOT NULL, INDEX fk14 (id_produit), PRIMARY KEY(idtype)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (idutilisateur INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, datenaissance DATE NOT NULL, adresse VARCHAR(255) NOT NULL, motdepasse INT NOT NULL, num_tel INT NOT NULL, image VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, role LONGTEXT NOT NULL, PRIMARY KEY(idutilisateur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE typeproduit ADD CONSTRAINT FK_F341609CF7384557 FOREIGN KEY (id_produit) REFERENCES produit (id_produit)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE typeproduit DROP FOREIGN KEY FK_F341609CF7384557');
